...
(function() {
  ...
  CircleTimer = (function() {
    function CircleTimer(ctx, pos1, r1, t, paused) {
      ...
      this._grad = this.ctx.createRadialGradient(this.pos.x, this.pos.y, this.r, this.pos.x, this.pos.y, 0);
    }
    ...
    CircleTimer.prototype.draw = function() {
      ...
      if (this.t > 0) {
        if (this.paused) {
          this._grad.addColorStop(0, "rgba(100, 0, 200, 0.5)");
          this._grad.addColorStop(1, "rgba(255, 255, 255, 0.5");
          this.ctx.fillStyle = this._grad;
        } else {
          this._grad.addColorStop(0, "rgba(0, 100, 200, 0.5)");
          this._grad.addColorStop(1, "rgba(255, 255, 255, 0.5");
          this.ctx.fillStyle = this._grad;
        }
        this.ctx.beginPath();
